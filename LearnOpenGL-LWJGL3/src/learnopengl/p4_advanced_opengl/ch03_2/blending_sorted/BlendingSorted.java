...
public class BlendingSorted {
	...
	public static void main(String[] args) {
		...
		Comparator<Vector3f> comparator = new Comparator<Vector3f>() {
			@Override
			public int compare(Vector3f a, Vector3f b) {
				final float aDistance = camera.position.distance(a);
				final float bDistance = camera.position.distance(b);
