package learnopengl.p4_advanced_opengl.ch02.stencil_testing;
...
public class StencilTesting {
	...
	public static void main(String[] args) {
		...
		final String dir = StencilTesting.class.getResource(".").getFile();
		Shader shader = new Shader(dir+"stencil_testing.vs", dir+"stencil_testing.fs");
		Shader shaderSingleColor = new Shader(dir+"stencil_testing.vs", dir+"stencil_single_color.fs");
		...
		while(!glfwWindowShouldClose(window)) {
			...
			// Since the stencil buffer is now filled with several 1s, the parts of the buffer that are 1 are not drawn,
