package learnopengl.p2_lighting.ch05_3_light_casters_spot;
...
public class LightCastersSpot {
	...
	public static void main(String[] args) {
		...
		final String dir = LightCastersSpot.class.getResource(".").getFile();
		Shader2 lightingShader = new Shader2(dir+"ch53_light_casters.vs", dir+"ch53_light_casters.fs");
		Shader2 lampShader = new Shader2(dir+"ch53_lamp.vs", dir+"ch53_lamp.fs");
