package learnopengl.p2_lighting.ch02_1_basic_lighting_diffuse;
...
public class BasicLightingDiffuse {
	...
	public static void main(String[] args) {
		...
		final String dir = BasicLightingDiffuse.class.getResource(".").getFile();
		Shader2 lightingShader = new Shader2(dir+"ch21_basic_lighting.vs", dir+"ch21_basic_lighting.fs");
		Shader2 lampShader = new Shader2(dir+"ch21_lamp.vs", dir+"ch21_lamp.fs");
