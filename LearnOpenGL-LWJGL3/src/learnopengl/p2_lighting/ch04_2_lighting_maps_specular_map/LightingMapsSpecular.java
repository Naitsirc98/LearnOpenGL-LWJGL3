package learnopengl.p2_lighting.ch04_2_lighting_maps_specular_map;
...
public class LightingMapsSpecular {
	...
	public static void main(String[] args) {
		...
		final String dir = LightingMapsSpecular.class.getResource(".").getFile();
		Shader2 lightingShader = new Shader2(dir+"ch42_lighting_maps.vs", dir+"ch42_lighting_maps.fs");
		Shader2 lampShader = new Shader2(dir+"ch42_lamp.vs", dir+"ch42_lamp.fs");
