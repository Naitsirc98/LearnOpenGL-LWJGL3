package learnopengl.p2_lighting.ch04_1_lighting_maps_diffuse_map;
...
public class LightingMapsDiffuse {
	...
	public static void main(String[] args) {
		...
		final String dir = LightingMapsDiffuse.class.getResource(".").getFile();
		Shader2 lightingShader = new Shader2(dir+"ch41_lighting_maps.vs", dir+"ch41_lighting_maps.fs");
		Shader2 lampShader = new Shader2(dir+"ch41_lamp.vs", dir+"ch41_lamp.fs");
