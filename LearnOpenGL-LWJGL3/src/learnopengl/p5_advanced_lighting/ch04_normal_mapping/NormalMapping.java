package learnopengl.p5_advanced_lighting.ch04_normal_mapping;
...
public class NormalMapping {
	...
	public static void main(String[] args) {
		...
		final String dir = NormalMapping.class.getResource(".").getFile();
		Shader2 shader = new Shader2(dir+"normal_mapping.vs", dir+"normal_mapping.fs");
		...
		// Load textures
		final int diffuseMap = loadTexture("resources/textures/brickwall.jpg");
		final int normalMap = loadTexture("resources/textures/brickwall_normal.jpg");
