package learnopengl.p5_advanced_lighting.ch03_2_2_point_shadows_soft;
...
public class PointShadowsSoft {
	...
	public static void main(String[] args) {
		...
		final String dir = PointShadowsSoft.class.getResource(".").getFile();
