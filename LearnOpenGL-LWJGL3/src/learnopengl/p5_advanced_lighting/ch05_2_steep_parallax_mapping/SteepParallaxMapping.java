package learnopengl.p5_advanced_lighting.ch05_2_steep_parallax_mapping;
...
public class SteepParallaxMapping {
	...
	public static void main(String[] args) {
		...
		final String dir = SteepParallaxMapping.class.getResource(".").getFile();
