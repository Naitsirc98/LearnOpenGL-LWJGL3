package learnopengl.p1_getting_started.ch07_4_camera_class;
...
public class CameraClass {
	...
	public static void main(String[] args) {
		...
		final String dir = CameraClass.class.getResource(".").getFile();
		Shader2 ourShader = new Shader2(dir+"ch74_camera.vs", dir+"ch74_camera.fs");
